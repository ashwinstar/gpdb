...
function configure() {
  pushd gpdb_src
      ...
      ./configure --prefix=/usr/local/greenplum-db-devel --with-perl --with-python PYTHON=/usr/bin/python3 --with-libxml --enable-mapreduce --enable-orafce --enable-tap-tests --disable-orca --with-openssl ${CONFIGURE_FLAGS}
